  ...
  useEffect(() => {
    ...
    const draw = (now: number) => {
      ...
      for (let i = 0; i < outline.length; i++) {
        ...
        ctx.fillStyle = `rgba(76,215,246,${(0.75 * tw * mapAlpha).toFixed(3)})`;
      ...
      for (const city of ALGERIA_CITIES) {
        ...
        g.addColorStop(0, `rgba(62,230,168,${0.55 * pulse * mapAlpha})`);
        g.addColorStop(1, "rgba(62,230,168,0)");
        ctx.fillStyle = g;
        ctx.beginPath();
        ctx.arc(pt.x, pt.y, 9, 0, Math.PI * 2);
        ctx.fill();
        ctx.fillStyle = `rgba(62,230,168,${0.95 * mapAlpha})`;
        ctx.beginPath();
      ...
      for (const target of REGION_TARGETS) {
        ...
        ctx.strokeStyle = `rgba(76,215,246,${0.28 * ringP})`;
        ctx.lineWidth = 1;
        ctx.stroke();
        ...
        if (ringP < 1) {
          ...
          ctx.fillStyle = "rgba(76,215,246,0.9)";
          ctx.beginPath();
          ...
          g.addColorStop(0, "rgba(76,215,246,0.5)");
          ...
          if (!reducedMotion) {
            ...
            ctx.fillStyle = "rgba(62,230,168,0.75)";
            ctx.beginPath();
      ...
      if (mapAlpha > 0.2) {
        ...
        g.addColorStop(0, `rgba(62,230,168,${0.6 * pulse * mapAlpha})`);
        g.addColorStop(1, "rgba(62,230,168,0)");
        ctx.fillStyle = g;
        ctx.beginPath();
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 55% at 42% 42%, rgba(76,215,246,0.07), transparent 65%)," +
            "radial-gradient(ellipse 45% 40% at 42% 42%, rgba(62,230,168,0.05), transparent 60%)",
        }}
      />
