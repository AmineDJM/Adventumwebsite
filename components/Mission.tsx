...
function Beacon({ className = "" }: { className?: string }) {
  return (
    <>
      ...
      <span
        className={`relative rounded-full bg-bio shadow-[0_0_12px_rgba(62,230,168,0.8)] ${className}`}
      />
    </>
  );
}
          ...
          >
            <defs>
              <linearGradient
                ...
                y2="100%"
              >
                <stop offset="0%" stopColor="#3ee6a8" stopOpacity="0" />
                <stop offset="10%" stopColor="#3ee6a8" />
                <stop offset="88%" stopColor="#4cd7f6" />
            ...
            <line
              ...
              strokeDasharray={100}
              strokeDashoffset={100}
              style={{ filter: "drop-shadow(0 0 6px rgba(62,230,168,0.45))" }}
            />
          </svg>
          ...
          >
            <svg className="h-full w-full overflow-visible">
              ...
              <line
                ...
                strokeDashoffset={100}
                style={{
                  filter: "drop-shadow(0 0 6px rgba(62,230,168,0.45))",
                }}
              />
            </svg>
